...
class InMemoryResearchBriefStoreV2:
    ...
    def __init__(self) -> None:
        self._briefs: dict[tuple[str, str], ResearchBriefV2] = {}
    ...
    async def get_brief(self, tenant_id: str, task_id: str) -> ResearchBriefV2 | None:
        async with self._lock:
            return self._briefs.get((tenant_id, task_id))
...
class ResearchV2ProviderAdapter:
    ...
    async def research(self, request: ResearchRequest) -> ResearchResult:
        try:
            brief = await self.brief_store.get_brief(request.tenant_id, request.task_id)
